...
import { Route as MytPipelineRouteImport } from './routes/myt/pipeline'
...
const MytPipelineRoute = MytPipelineRouteImport.update({
  id: '/myt/pipeline',
  path: '/myt/pipeline',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/myt/pipeline': typeof MytPipelineRoute
...
export interface RootRouteChildren {
  ...
  MytPipelineRoute: typeof MytPipelineRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/myt/pipeline': {
      id: '/myt/pipeline'
      path: '/myt/pipeline'
      fullPath: '/myt/pipeline'
      preLoaderRoute: typeof MytPipelineRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/myt/owners-compare': {
      id: '/myt/owners-compare'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  MytPipelineRoute: MytPipelineRoute,
