...
import { LeadScoreBadge } from "@/components/crm-features/LeadScoreBadge";
import { PriorityTagStrip } from "@/components/crm-features/PriorityTagStrip";
import { WhatsAppGenerator } from "@/components/crm-features/WhatsAppGenerator";
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-xl border border-border bg-card overflow-hidden">
          <div className="grid grid-cols-12 px-4 py-2 text-[10px] uppercase tracking-wider text-muted-foreground font-semibold border-b border-border bg-muted/40">
            ...
            <div className="col-span-2">Score · Intent</div>
              ...
              return (
                <div key={l.id} className="relative group">
                  ...
                  <div className="absolute right-3 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <WhatsAppGenerator lead={l} variant="icon" />
                  </div>
                </div>
              );
            })}
