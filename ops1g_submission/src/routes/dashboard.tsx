...
import {
  ...
  RevenueForecastCard,
  FollowUpNeededCard,
  LostReasonAnalyticsCard,
  TCMPerformanceCard,
  LeadScoreSummaryCard,
  TourTrackerCard,
  TokenTrackerDashboardCard,
} from "@/components/crm-features/CRMDashboardCards";
  ...
  return (
    <AppShell>
      <div className="space-y-6">
        ...
        {/* ============================================================
            CRM FEATURES — Added Features 1, 2, 5, 6, 7, 9, 10
            ============================================================ */}

        {/* Row: Lead Score Summary + Revenue Forecast */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <LeadScoreSummaryCard />
          <RevenueForecastCard />
        </div>
        ...
        {/* Row: Tour Tracker + Token Tracker */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <TourTrackerCard />
          <TokenTrackerDashboardCard />
        </div>

        {/* Row: Pipeline Funnel + TCM Performance */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <PipelineStageCard />
          <TCMPerformanceCard />
        </div>
